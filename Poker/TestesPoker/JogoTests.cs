...
namespace TestesPoker
{
    ...
    public class JogoTestes
    {
        ...
        public void jogador1Ganha()
        {
            ...
            jogo.getGanhador().Should().Be("Jogador 1");
        }
        [TestMethod]
        public void jogador2Ganha()
        {
            Jogador jogador = new Jogador("5H 5C 6S 7S KD");
            Jogador jogador2 = new Jogador("7H 7C 7S 9S TD");
            Jogo jogo = new Jogo(new List<Jogador>() { jogador, jogador2 });

            jogo.getGanhador().Should().Be("Jogador 2");
        }
        [TestMethod]
        public void jogador2Ganha2()
        {
            Jogador jogador = new Jogador("5H 5C 6S 7S KD");
        ...
        [TestMethod]
        public void empataCartaAltaJ1Ganha()
        {
        ...
        [TestMethod]
        public void empataCartaAltaJ1Ganha1()
        {
        ...
        [TestMethod]
        public void empataCartaAltaJ2Ganha()
        {
        ...
        [TestMethod]
        public void duasTrincasJ1Ganha()
        {
        ...
        [TestMethod]
        public void duasTrincasJ2Ganha()
        {
        ...
        [TestMethod]
        public void empataTrincasJ2Ganha()
        {
            Jogador jogador = new Jogador("5H 5C 5S 6S 7D");
        ...
        [TestMethod]
        public void empataTrincasJ2Ganha2()
        {
        ...
        public void empataRoyalFlush()
        {
            ...
            jogo.getGanhador().Should().Be("Empate");
        }
        [TestMethod]
        public void variosJogadoresJ4Ganha()
        {
            ...
            jogo.getGanhador().Should().Be("Jogador 4");
        }
        [TestMethod]
